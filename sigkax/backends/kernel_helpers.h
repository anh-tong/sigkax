/*
This is from https://github.com/google/jax/blob/main/jaxlib/kernel_helpers.h
*/

#ifndef SIGKAX_KERNEL_HELPERS_H_
#define SIGKAX_KERNEL_HELPERS_H_
...
#endif /* SIGKAX_KERNEL_HELPERS_H_ */
